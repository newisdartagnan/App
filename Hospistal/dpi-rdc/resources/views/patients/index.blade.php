...
<div class="max-w-7xl mx-auto px-4 py-6">
    ...
    {{-- Recherche au fil de la frappe (JS pur, indépendante de Livewire) --}}
    ...
    <form method="GET" action="{{ route('patients.index') }}" class="flex gap-3 mb-4">
        ...
        <label for="filtre-sexe" class="sr-only">Sexe</label>
        <select id="filtre-sexe" name="sexe" class="min-h-[44px] rounded-lg border border-gray-300 px-3">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 font-medium">
                        <a href="{{ route('patients.show', $patient) }}" class="hover:text-blue-700">{{ $patient->nom_complet }}</a>
                    </td>
